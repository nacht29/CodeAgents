...
- If implementation violates project rules: "Must consult @agents-md-compliance-checker before approval"
...
3. @agents-md-compliance-checker (verify changes follow project rules)"
...
2. @agents-md-compliance-checker (confirm implementation follows project standards)"
